...
const roleNavItems: Record<Roles, NavItem[]> = {
  [Roles.ISSUER]: [
  ...
  [Roles.ADMIN]: [
    ...
    { label: 'Re-Evaluations', icon: RefreshCcw, href: '/reevaluations' },
  ],
  [Roles.CHECKER]: [
    { label: 'Dashboard', icon: LayoutDashboard, href: '/dashboard' },
...
export function Sidebar({
  ...
  // Use getPrimaryRole to select the navigation items for the user's highest priority role
    ...
    return (
      ...
      >
        ...
        {item.badge && (
          <Badge
            variant="secondary"
            className="text-[10px] px-1.5 py-0 bg-sidebar-primary/20 text-sidebar-primary-foreground"
          >
            {item.badge}
          </Badge>
        )}
          ...
          >
            ...
            {showExpanded && (
              <div className="min-w-0">
                <h1 className="font-semibold text-sidebar-foreground text-sm truncate">
                  Authentico
                </h1>
